  ...
  async (req, res) => {
    ...
    try {
      ...
      if (!paystackResponse.status) {
        ...
        // You might want to remove the pending ticket here or mark it with a Paystack error status
        // await Ticket.findByIdAndDelete(ticket._id); // Option 1: Delete the ticket
        // ticket.payment_status = 'initialization_failed'; await ticket.save(); // Option 2: Mark as failed
      ...
      await ticket.save() // Update the ticket document
